                ...
                <div class="x_panel">
                  ...
                  <div class="x_content" align="center">
                        <div class="bs-example" data-example-id="simple-jumbotron">
                          ...
                          <div class="jumbotron">
                            <h3 align="center"><b>ARQUIDIOCESIS DE COCHABAMBA</b></h3><br>
                            <h3 align="left"><b>HISTORIA</b></h3><br>
                            <h4 align="justify"><?php echo $key->historia; ?></h4><br>
                            <h3 align="left"><b>ADMINISTRACION</b></h3><br>
                            ...
                            <div class="col-md-4 col-xs-12">
                                ...
                                <h2><b><br></b></h2>
                                <h2><b>ARQUIDIOCESIS DE COCHABAMBA</b></h2>
                        ...
                        <!-- end of skills -->
                          </div><a class="btn btn-success" align="right"><i class="fa fa-edit m-right-xs"></i>EXPORTAR A PDF</a>

                    </div>
                </div><br>


                                <?php print_r($jurisdiccion) ?>
