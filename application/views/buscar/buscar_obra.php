          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  <h2 align="center"><strong>OBRAS DE LA IGLESIA</strong> <br> Encuentre una obra de la Iglesia</h2>
                  ...
                  <div class="x_content" align="center">
                    <form class="form-label-left input_mask" align="center" action="<?php echo base_url();?>buscar/obras" method="POST"  id="formObis"><br>
                      <label class="col-md-4 col-sm-9 col-xs-9 col-md-offset-2" align="left">Jurisdicciones Eclesiastica:</label><label class="col-md-3" align="left">Ciudad:</label><div class="clearfix"></div>
                       <div class="col-md-4 col-sm-9 col-xs-9 col-md-offset-2 form-group has-feedback">
                        ...
                        <label class="control-label col-md-4 col-sm-9 col-xs-9 col-md-offset-2" align="left">Tipo de Obra:</label><label class="control-label col-md-3" align="left">Texto:</label><div class="clearfix"></div>
                         <div class="col-md-4 col-sm-9 col-xs-9 col-md-offset-2 form-group has-feedback">
                            <!--<input required="required" type="text" class="form-control has-feedback-right" id="inputSuccess2" placeholder="Ingrese Tipo">-->
                            <select  name="obra" class="form-control" required>
                              <option value="0">Todas las Obras Iglesia</option>
