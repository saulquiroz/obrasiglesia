...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
      ...
      <h2 align="center"><strong>OBISPOS REGISTRADOS</strong></h2>
      <div class="clearfix"></div>
    ...
    <div class="x_content">
      ...
      <table id="datatable" class="table table-striped table-bordered">
        <thead>
          <tr align="center">
            <th>Nombre</th>
            <th>Ordenacion Sacerdotal</th>
            <th>Ordenacion Episcopal</th>
            <th>Ubicacion</th>
            <th>Opciones</th>
          </tr>
        </thead>
        <tbody>
          <?php foreach ($resultado as $r) {
            ...
            echo '<td>'.$r->ordenacionSacerdotal.'</td>';
            echo '<td>'.$r->ordenacionEpiscopal.'</td>';
            echo '<td>'.$r->ubicacion.'</td>';
            echo '<td>';
          ...
          //  if($this->permission->checkPermission($this->session->userdata('permissao'),'dVenda')){
              echo '<a href="'.base_url().'obispo/visualizar/'.$r->cod_usuario.'" class="btn btn-primary"><i class="fa fa-eye"></i> Observar </a>';
        //    }
              echo '<a href="'.base_url().'obispo/delete/'.$r->cod_usuario.'" class="btn btn-danger"><i class="fa fa-trash-o"></i> Eliminar </a>';
