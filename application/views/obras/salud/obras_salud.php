     ...
     <div class="right_col" role="main">
          <div class="">
            <div class="col-md-10 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2><i class="fa fa-spinner"></i> Registro Nuevo - Obra de Salud</h2>
                ...
                <form class=" form-label-left input_mask" align="center" action="<?php base_url();?>salud/registrar" method="POST">
