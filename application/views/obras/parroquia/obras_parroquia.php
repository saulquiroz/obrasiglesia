     ...
     <div class="right_col" role="main">
          <div class="">
            <div class="col-md-10 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2><i class="fa fa-spinner"></i> Registro Nuevo - Parroquia</h2>
            ...
            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                ...
                <form class=" form-label-left input_mask" align="center" action="<?php echo base_url();?>parroquia/registrar" method="POST">
...
<div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                  ...
                  <label class="control-label col-md-4" for="first-name">Numero de personas que trabajan en la obra: </label>
                            <div class="ccol-md-7 col-sm-7 col-xs-12  form-group ">
                              ...
                              <input id="" type="number" name="numero_personas" class="form-control has-feedback-right"  placeholder="" value="">
