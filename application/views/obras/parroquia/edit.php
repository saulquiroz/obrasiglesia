<!-- <?php #echo form_open('parroquia/update', 'role="form"'); ?> -->
     ...
     <div class="right_col" role="main">
          <div class="">
            <div class="col-md-10 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2><i class="fa fa-spinner"></i> Editar - Obra Parroquia </h2>
                ...
                <form class=" form-label-left input_mask" align="center" action="<?php echo base_url();?>parroquia/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="x_panel">
                          <div class="x_tittle"><h2 align="left"><i class="fa fa-university"></i> Informacion Jurisdiccion</h2></div><div class="clearfix"></div><br>
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 form-group has-feedback">
                              ...
                              <input id="jurisdiccion" required="required" type="text" name="jurisdiccion" class="form-control has-feedback-right"  value="" >
