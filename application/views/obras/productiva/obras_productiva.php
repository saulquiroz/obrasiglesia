     ...
     <div class="right_col" role="main">
          <div class="">
            <div class="col-md-10 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2><i class="fa fa-spinner"></i> Registro Nuevo <small>Obra Productiva</small></h2>
                ...
                <form class=" form-label-left input_mask" align="center" action="<?php echo base_url();?>productiva/registrar" method="POST">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title "><center>Servicios</center> </th>
                            <th class="column-title col-md-15"><center>Productos/Actividades</center> </th>
                            <th class="column-title">Beneficiarios</th>
                        ...
                        <tbody>
                           ...
                           <tr class="even pointer">
                            ...
                            <td class=" "></td>
                            <td class=" "><TABLE >
                                <TR><TD class="col-md-20 col-sm-12 col-xs-12"><center>V</center></TD><TD class="col-md-20 col-sm-12 col-xs-12"><center>M</center></TD></TR>
                           </TABLE>
                           </td>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">Actividades Agricolas</td>
                            <td class="col-md-6 col-sm-12 col-xs-12 form-group "><input type="text" class="form-control"></td>
                            <td class=" "><TABLE><TR><TD><center><input type="text" class="form-control"></center></TD><TD><center><input type="text" class="form-control"></center></TD></TR>
                           </TABLE>
                           </td>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" ">Actividades Pecuarias</td>
                            <td class=" "><input type="text" class="form-control"></td>
                            <td class=" "><TABLE><TR><TD><center><input type="text" class="form-control"></center></TD><TD><center><input type="text" class="form-control"></center></TD></TR>
                           </TABLE>
                            </td>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">Actividades textiles</td>
                            <td class=" "><input type="text" class="form-control"></td>
                            <td class=" "><TABLE><TR><TD><center><input type="text" class="form-control"></center></TD><TD><center><input type="text" class="form-control"></center></TD></TR>
                            </TABLE>
                            </td>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" ">Actividades de madera</td>
                            <td class=" "><input type="text" class="form-control"></td>
                            <td class=" "><TABLE><TR><TD><center><input type="text" class="form-control"></center></TD><TD><center><input type="text" class="form-control"></center></TD></TR>
                            </TABLE></td>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">Actividades de metalmecanica</td>
                            <td class=" "><input type="text" class="form-control"> </td>
                            <td class=" "><TABLE><TR><TD><center><input type="text" class="form-control"></center></TD><TD><center><input type="text" class="form-control"></center></TD></TR>
                            </TABLE></td>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" ">Actividades de Financiamiento</td>
                            <td class=" "><input type="text" class="form-control"></td>
                            <td class=" "><TABLE><TR><TD><center><input type="text" class="form-control"></center></TD><TD><center><input type="text" class="form-control"></center></TD></TR>
                            </TABLE>
                            </td>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">Actividades de Capacitacion</td>
                            <td class=" "><input type="text" class="form-control"></td>
                            <td class=" "><TABLE><TR><TD><center><input type="text" class="form-control"></center></TD><TD><center><input type="text" class="form-control"></center></TD></TR>
                            </TABLE></td>
