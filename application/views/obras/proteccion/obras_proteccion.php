     ...
     <div class="right_col" role="main">
          <div class="">
            <div class="col-md-10 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2><i class="fa fa-spinner"></i> Registro Nuevo <small>Obra de Proteccion</small></h2>
                ...
                <form class=" form-label-left input_mask" align="center" action="<?php echo base_url();?>proteccion/registrar" method="POST">
                ...
                <div class="x_title">
                    ...
                    <div class="table-responsive">
                      ...
                      <div role="tabpanel" class="tab-pane fade" id="tab_content6" aria-labelledby="profile-tab">
                        <div class="x_panel">
                  <div class="x_title">
                    <h2>Obras de Proteccion Social</h2>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                           ...
                           <tr class="even pointer">
                            ...
                            <td class=" "><TABLE >
                                <TR><TD class="col-md-10 col-sm-6 col-xs-6">V</TD><TD class="col-md-10 col-sm-6 col-xs-6">M</TD></TR>
                           </TABLE>
                           </td>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" ">Hogares de Acogida</td>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">Comedores Populares</td>
