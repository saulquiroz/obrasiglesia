...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
      ...
      <h2 align="center"><strong>Lista de obras de Administrativas</strong></h2>
      <div class="clearfix"></div>
      ...
      <table id="datatable" class="table table-striped table-bordered">
        ...
        <tbody>
          ...
          //  if($this->permission->checkPermission($this->session->userdata('permissao'),'dVenda')){
              echo '<a href="'.base_url().'obras/visualizar_administrativa/'.$r->cod_obrasdatos.'" class="btn btn-primary btn-xs"><i class="fa fa-mail-forward"></i> Detalle </a>';
        //    }
              echo '<a href="'.base_url().'obras/delete_admin/'.$r->cod_obrasdatos.'" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Eliminar </a>';
