     ...
     <div class="right_col" role="main">
          <div class="">
            <div class="col-md-10 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2><i class="fa fa-spinner"></i> Registro Nuevo <small>Obra de Comunicacion</small></h2>
                ...
                <div class="x_content">
                  ...
                  <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                      ...
                      <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab5" data-toggle="tab" aria-expanded="false">Personal y Bienes</a>
                      </li>
                      <li role="presentation" class=""><a href="#tab_content4" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Documentos</a>
                      </li>
                      ...
                      <li role="presentation" class=""><a href="#tab_content6" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Tipo de Obra</a>
                      </li>
                      <li role="presentation" class=""><a href="#tab_content7" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Otros Datos</a>
                      </li>
                    </ul>
                <form class=" form-label-left input_mask" align="center" action="<?php echo base_url();?>comunicacion/registrar" method="POST">
                    <div id="myTabContent" class="tab-content">
                      ...
                      <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                        <div class="x_panel">
                          ...
                          <input id="jurisdiccion"type="text" name="jurisdiccion" class="form-control has-feedback-right"  placeholder="Ingrese la jurisdiccion" value="">
            ...
            <div class="x_panel">
             <h2>Documentos legales vinculados a la iglesia</h2>
                ...
                <div class="x_title">
                  ...
                  <label class="control-label col-md-2" for="first-name">Cod. Ministerio: </label>
                            <div class="ccol-md-7 col-sm-7 col-xs-12  form-group ">
                                 <span class="fa fa-male form-control-feedback right" aria-hidden="true"></span>
                              <input id="" type="text" name="" class="form-control has-feedback-right"  placeholder="" value="">
                              <input id="" class="col-md-12" type="hidden" name="" value=""  />
                            </div><div class="clearfix"></div>
                            <label class="control-label col-md-2" for="first-name">Tipo: </label>
                            <div class="ccol-md-7 col-sm-7 col-xs-12  form-group ">

                              <div class="radio">
                            <label>
                              <input type="radio" checked="" value="option1" id="optionsRadios1" name="optionsRadios">Privada
                            </label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" value="option2" id="optionsRadios2" name="optionsRadios">Convenio
                            </label>
                          </div>
                            </div><div class="clearfix"></div>
                            <label class="control-label col-md-2" for="first-name">Convenio con: </label>
                            <div class="ccol-md-7 col-sm-7 col-xs-12  form-group ">
                                 <span class="fa fa-male form-control-feedback right" aria-hidden="true"></span>
                              <input id="" type="text" name="" class="form-control has-feedback-right"  placeholder="" value="">
                              <input id="" class="col-md-12" type="hidden" name="" value=""  />
...
<div class="x_panel">
    <h2>Medios de Comunicacion Social-Impresos</h2>
                  <div class="x_title">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Periodicidad </th>
                            <th class="column-title">Diario</th>
                            <th class="column-title">Quincenal</th>
                            <th class="column-title">Mensual</th>
                            <th class="column-title">Otro</th>
                            <th class="column-title">Formato</th>
                            <th class="column-title">Tiraje</th>
                  ...
                  <h2>Medios de Comunicacion Social-Radio</h2>
                  <div class="x_title">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title ">Banda </th>
                            <th class="column-title">Frecuencia</th>
                            <th class="column-title ">Potencia </th>
                            <th class="column-title">Audencia Estimada</th>
                  ...
                  <h2>Medios de Comunicacion Social-Television</h2>
                  <div class="x_title">
                  ...
                  <h2>Medios de Comunicacion Social-Productoras de Audio</h2>
                  <div class="x_title">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title ">Totales </th>
                            <th class="column-title">Produccion/Año</th>
                  ...
                  <h2>Medios de Comunicacion Social-Productoras de Video</h2>
                  <div class="x_title">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">Formato Betacam SP</td>
