     ...
     <div class="right_col" role="main">
          <div class="">
            <div class="col-md-10 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2><i class="fa fa-spinner"></i> Registro Nuevo <small>Obra de Movilidad Humana</small></h2>
                ...
                <form class=" form-label-left input_mask" align="center" action="<?php echo base_url();?>movilidad/registrar" method="POST">
                ...
                <div class="x_title">
                    ...
                    <div class="table-responsive">
                      ...
                      <div role="tabpanel" class="tab-pane fade" id="tab_content6" aria-labelledby="profile-tab">
                        <div class="x_panel">
                  <div class="x_title">
                    <h2>Obras de Pastoral de Movilidad Humana-PMH</h2>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" ">Trata y Trafico de Personas</td>
