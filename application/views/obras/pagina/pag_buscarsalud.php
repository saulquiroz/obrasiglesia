<div class="col-md-10 col-sm-10 col-xs-10 col-md-offset-1"><br><br>
  <div class="x_panel"><br><br>
    <h2 align="center"><strong>RESULTADO DE LA BUSQUEDA DE OBRAS SALUD</strong></h2>
      <div class="clearfix"></div>
        <div class="x_content" align="center">
                    <form class="form-label-left input_mask" align="center" action="<?php echo base_url();?>pag_busqueda/busquedasalud" method="POST"  id="formObis"><br>
                      ...
                      <!--  <label class="control-label col-md-4 col-md-offset-2" align="left">Tipo de Obra:</label><label class="control-label col-md-3" align="left">Texto a Buscar:</label><div class="clearfix"></div>
                        ...
                        <input id="obra" class="col-md-12" type="hidden" name="obra" value="4"  />
                        </div>
